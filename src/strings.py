...
def party_soon(
    ...
    if items:
        ...
        text += "\n\nВы не выбрали ни одного подарка из вишлиста ☹️. " \
                "Для того, чтобы выбрать подарок, вам нужно выбрать его в списке, нажать на него, " \
                "а потом тыкнуть на кнопку «Я подарю это!», и только тогда все остальные увидят, " \
                "что вы подарите его! Не ленитесь нажимать кнопку, чтобы два человека не купили один подарок 😊" \

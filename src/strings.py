...
find_friends_wishlist = "🔎 Вишлист друга"
...
enter_wishlist_title = "<b>Введите название вашего вишлиста</b>. " \
                       "Его увидят все, кому вы отправите вишлист. " \
...
cant_find_wishlist = "Мы не может найти этот вишлист. Пожалуйста, введите хэш в правильном формате " \
                     "(например #ABCD1) или попросите ссылку у друга"

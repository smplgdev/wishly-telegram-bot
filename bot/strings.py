...
how_old_are_you_2 = ("Сколько лет тебе исполняется? Ответив на этот вопрос, я смогу подобрать для тебя интересные подарки, которые ты сможешь добавить в свой вишлист")
